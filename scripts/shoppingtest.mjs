...
// 2026-09-19 嫩莢類歸蔬菜（類別覆寫表）：四季豆、豌豆莢在買菜清單上跟青菜放一起，不在豆製品那一區
eq([sectionOf(idx.byId.get('H1000201')), sectionOf(idx.byId.get('H1200201'))], ['蔬菜', '蔬菜'], '四季豆（敏豆莢）、豌豆莢 → 蔬菜區');
eq(sectionOf(idx.byId.get('H1100101')), '豆製品蛋奶', '（對照）毛豆仁（吃豆仁的，仍是豆類）→ 豆製品蛋奶');
