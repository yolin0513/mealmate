...
const MUTATIONS = [
  ...
  },
  {
    ...
    why: "平衡要誠實講出來，不是偷偷調。",
    file: "js/views/week.js",
    find: "  render(head, wantCard, diagCard, balanceCard, pastNote, grid, noticeFooter());",
    replace: "  render(head, wantCard, diagCard, pastNote, grid, noticeFooter());",
    test: "weekviewtest",
  },
  {
    ...
    file: "js/views/week.js",
    find: "    rules: { noRepeatDays: prefs.get('noRepeatDays'), avoid: prefs.get('avoid'), heartyLevel: prefs.get('heartyLevel'), riceKind: prefs.get('riceKind') },\n    favorites: store.favoritesList(), history: await store.history(), mondayIso, seed, prevPlan,",
    replace: "    rules: { noRepeatDays: prefs.get('noRepeatDays'), avoid: prefs.get('avoid'), riceKind: prefs.get('riceKind') },\n    favorites: store.favoritesList(), history: await store.history(), mondayIso, seed, prevPlan,",
    test: "weekviewtest",
  },
  {
    name: "豐盛程度的預設不是適中",
  ...
  },
  {
    ...
    file: 'js/views/week.js',
    find: "    rules: { noRepeatDays: prefs.get('noRepeatDays'), avoid: prefs.get('avoid'), heartyLevel: prefs.get('heartyLevel'), riceKind: prefs.get('riceKind') },",
    replace: "    rules: { noRepeatDays: prefs.get('noRepeatDays'), avoid: prefs.get('avoid'), heartyLevel: prefs.get('heartyLevel') },",
    test: 'familytest',
  },
  {
