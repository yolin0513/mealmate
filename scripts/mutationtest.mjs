...
const MUTATIONS = [
  ...
  },
  {
    ...
    find: "  render(head, diagCard, balanceCard, haveCard, h('div', { class: 'week-grid' }, ...dayCards), noticeFooter());",
    replace: "  render(head, diagCard, haveCard, h('div', { class: 'week-grid' }, ...dayCards), noticeFooter());",
    test: "weekviewtest",
  },
  {
  ...
  },
  {
    ...
    why: '「煮熟」一句話也算食譜。',
    file: 'js/recipeschema.js',
    find: "  if (steps.length < minSteps) err(relax ? '至少要寫 1 個步驟' : `步驟至少 3 步，只有 ${steps.length}`);",
