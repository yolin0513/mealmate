...
const MUTATIONS = [
  ...
  },
  {
    ...
    why: '週一買的葉菜排到週日煮。',
    file: 'js/planner.js',
    find: '      if (days != null && since > days) return `shelf:${ing.label}`;',
    replace: '      if (false) return `shelf:${ing.label}`;',
    test: 'plannertest',
  },
  {
    name: '重新產生時忽略鎖住的菜',
  ...
  },
  {
    ...
    file: 'js/planner.js',
    find: "        items.push({ recipeId: recipe.id, role, locked: false, reasons, method: recipe.method });",
  ...
  },
  {
    ...
    find: "                  h('span', { class: 'shop-qty num' }, quantityText(it))),",
    replace: "                  h('span', { class: 'shop-qty num' }, `約 ${it.grams} g`)),",
